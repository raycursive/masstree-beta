#ifndef SIMPLETEST_AVLTREE_HH
#define SIMPLETEST_AVLTREE_HH
...
class avltree_test_client
        : public simple_kvtest_client<avltree::default_table, avltree_test_client> {
public:
    using simple_kvtest_client<avltree::default_table, avltree_test_client>::simple_kvtest_client;
...
MAKE_TESTRUNNER(avltree_test_client, rw1, kvtest_rw1(client));
MAKE_TESTRUNNER(avltree_test_client, rw1puts, kvtest_rw1puts(client));
MAKE_TESTRUNNER(avltree_test_client, ruscale_init,
                kvtest_ruscale_init(client));
MAKE_TESTRUNNER(avltree_test_client, rscale, kvtest_rscale(client));
